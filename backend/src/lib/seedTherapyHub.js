      ...
      const relaxationExercises = [
        {
          ...
          audioUrl: "https://carewave12345.blob.core.windows.net/audio/relaxation/1-brief-mindfulness.mp3",
          displayOrder: 1,
        ...
        },
        {
          ...
          category: "Relaxation Sessions",
          audioUrl: "https://carewave12345.blob.core.windows.net/audio/relaxation/2-leaves-on-a-stream.mp3.mpeg",
          displayOrder: 2,
          recommendedStressLevels: ["Mild", "Moderate", "Severe", "Extremely Severe"],
        ...
        },
        {
          ...
          category: "Relaxation Sessions",
          audioUrl: "https://carewave12345.blob.core.windows.net/audio/relaxation/3-progressive-muscle-relaxation.mp3",
          displayOrder: 3,
          recommendedStressLevels: ["Mild", "Moderate", "Severe", "Extremely Severe"],
        ...
        },
        {
          ...
          category: "Relaxation Sessions",
          audioUrl: "https://carewave12345.blob.core.windows.net/audio/relaxation/4-abdominal-breathing.mp3",
          displayOrder: 4,
          recommendedStressLevels: ["Mild", "Moderate", "Severe", "Extremely Severe"],
        ...
        },
        {
          ...
          category: "Relaxation Sessions",
          audioUrl: "https://carewave12345.blob.core.windows.net/audio/relaxation/5-managing-math-anxiety.mp3",
          displayOrder: 5,
          recommendedStressLevels: ["Mild", "Moderate", "Severe", "Extremely Severe"],
        ...
        },
        {
          ...
          category: "Relaxation Sessions",
          audioUrl: "https://carewave12345.blob.core.windows.net/audio/relaxation/6-body-image.mp3",
          displayOrder: 6,
          recommendedStressLevels: ["Mild", "Moderate", "Severe", "Extremely Severe"],
      ...
      const musicExercises = [
        {
          ...
          category: "Calm Music",
          audioUrl: "https://carewave12345.blob.core.windows.net/audio/music/ambient-nature.mp3",
          displayOrder: 1,
        ...
        },
        {
          ...
          category: "Calm Music",
          audioUrl: "https://carewave12345.blob.core.windows.net/audio/music/Inspiring-Dreams.mp3",
          displayOrder: 2,
          recommendedStressLevels: ["Normal", "Mild", "Moderate"],
        ...
        },
        {
          ...
          category: "Calm Music",
          audioUrl: "https://carewave12345.blob.core.windows.net/audio/music/Laetha.mp3",
          displayOrder: 3,
          recommendedStressLevels: ["Normal", "Mild", "Moderate"],
        ...
        },
        {
          ...
          category: "Calm Music",
          audioUrl: "https://carewave12345.blob.core.windows.net/audio/music/Magical-Moments.mp3",
          displayOrder: 4,
          recommendedStressLevels: ["Normal", "Mild", "Moderate"],
        ...
        },
        {
          ...
          category: "Calm Music",
          audioUrl: "https://carewave12345.blob.core.windows.net/audio/music/Warm-Memories.mp3",
          displayOrder: 5,
          recommendedStressLevels: ["Normal", "Mild", "Moderate"],
        ...
        },
        {
          ...
          category: "Calm Music",
          audioUrl: "https://carewave12345.blob.core.windows.net/audio/music/Winter.mp3",
          displayOrder: 6,
          recommendedStressLevels: ["Normal", "Mild", "Moderate"],
      ...
      const natureExercises = [
        {
          ...
          audioUrl: "https://carewave12345.blob.core.windows.net/audio/nature/atmospheric-wind.mp3",
          displayOrder: 1,
        ...
        },
        {
          ...
          category: "Nature Sounds",
          audioUrl: "https://carewave12345.blob.core.windows.net/audio/nature/happy-birds-singing.mp3",
          displayOrder: 2,
          recommendedStressLevels: ["Normal", "Mild", "Moderate", "Severe"],
        ...
        },
        {
          ...
          category: "Nature Sounds",
          audioUrl: "https://carewave12345.blob.core.windows.net/audio/nature/nightingale-song-in-forest.mp3",
          displayOrder: 3,
          recommendedStressLevels: ["Normal", "Mild", "Moderate", "Severe"],
        ...
        },
        {
          ...
          category: "Nature Sounds",
          audioUrl: "https://carewave12345.blob.core.windows.net/audio/nature/ocean-waves.mp3",
          displayOrder: 4,
          recommendedStressLevels: ["Normal", "Mild", "Moderate", "Severe"],
        ...
        },
        {
          ...
          category: "Nature Sounds",
          audioUrl: "https://carewave12345.blob.core.windows.net/audio/nature/river-in-forest.mp3",
          displayOrder: 5,
          recommendedStressLevels: ["Normal", "Mild", "Moderate", "Severe"],
